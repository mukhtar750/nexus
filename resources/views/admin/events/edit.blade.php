                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="start_time" id="start_time"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required value="{{ old('start_time', $event->start_time->format('Y-m-d\TH:i')) }}">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="end_time" id="end_time"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required value="{{ old('end_time', $event->end_time->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="col-span-2">
                        ...
                        @if($event->cover_image_url)
                            <div class="mb-2">
                                <img src="{{ $event->cover_image_url_full }}" alt="Current Cover"
                    ...
                    <div class="col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="requires_invitation" value="1"
                                ...
                                {{ old('requires_invitation', $event->requires_invitation) ? 'checked' : '' }}>
